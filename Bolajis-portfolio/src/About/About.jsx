...
function AboutBolaji() {
  ...
  const studentText = (
    <p>
      My name is Folarin Bolaji Samuel. I am an undergraduate <strong>student</strong> of
      Microbiology at Bells University of Technology, and also a concurrent
      undergraduate student of Health Science at an American-based university. I
      am deeply passionate about education, research, and continuous learning,
      and I often describe myself as an educationist because of my strong
  ...
  const microbiologistText = (
    <p>
      My name is Folarin Bolaji Samuel. I am a budding <strong>microbiologist</strong>{" "}
      combining my studies at Bells University of Technology with Health Science
      curriculum from an American-based university. I am deeply passionate about
      scientific inquiry, lab research, and continuous discovery, and I often
      describe myself as a scientist because of my strong commitment to
      understanding the microscopic world and its impact on humanity.
    </p>
  );
            ...
            <div className="box-big bg-[#191919] text-white w-full md:w-[533.87px] py-10 px-6  md:p-10 rounded-lg rounded-tl-none text-lexgend font-light text-sm md:text-md/[30px] md:font-light leading-7 shadow-2xl">
              ...
              <div className="download flex justify-end transition duration-900 ease-in-out">
                <button className="group mt-8 md:w-auto cursor-pointer flex items-center bg-(--default-orange) text-black p-5  h-12 w-12 rounded-full font-bold transition-all duration-300 ease-in-out hover:bg-[#f9a83f]">
                  <img src={DownloadIcon} alt="Download" className="w-4 h-4 mx-auto" />
